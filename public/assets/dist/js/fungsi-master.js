...
function genGridMaster(modnya, divnya, lebarnya, tingginya) {
	...
	switch (modnya) {
		...
		case "kategori":
			...
			kolom[modnya] = [
				{ field: 'nama', title: 'Nama Kategori', width: 200, halign: 'center', align: 'left' },
		...
		case "pekerjaan":
			...
			fitnya = true,
				...
				kolom[modnya] = [
					{ field: 'nama', title: 'Nama Pekerjaan', width: 200, halign: 'center', align: 'left' },
				];
			break;
		...
		case "pendidikan":
			...
			fitnya = true,
				...
				kolom[modnya] = [
					{ field: 'nama', title: 'Nama Pendidikan', width: 200, halign: 'center', align: 'left' },
				];
			break;
	}
