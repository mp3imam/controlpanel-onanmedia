...
class RequestPencarianDanaController extends Controller
{
    ...
    {
        $this->middleware('permission:Request Pencarian Dana');
    }
    ...
    public function index(){
        ...
        return view('request_pencarian_dana.index', $title);
    }
    ...
    public function models($request){
        return RequestPencarianDanaModel::query()
        ->select('Pencairan.*', 'User.name as userid', 'MsBank.nama as msbankid')
        ->leftJoin('User', 'User.id', '=', 'Pencairan.userId')
        ->leftJoin('MsBank', 'MsBank.id', '=', 'Pencairan.msBankId')
        ->get();
    }
