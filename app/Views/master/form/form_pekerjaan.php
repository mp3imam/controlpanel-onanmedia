<form id="form_{$acak}" method="post" url="{$baseurl}master/simpan/pekerjaan" enctype="multipart/form-data" >
    ...
    <div class="row mb-2">
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    {include file="components/input_form.php" required="true" label="Nama Pekerjaan" class_width="col-lg-12" type="text" name="nama" id="nama" value="{$data.nama|default:''}"}
                </div>
            </div>
