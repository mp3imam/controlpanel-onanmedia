                        ...
                        <div class="row mb-3">
                            <div class="col-md mb-3">
                                ...
                                <textarea class="form-control" rows="4" cols="50" placeholder="Tulis deskripsi pembelanjaan di sini...."
                                    name="deskripsi" required readonly>{{ $detail->keterangan_kas }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                                ...
                                <div class="card-body tambah_detail">
                                    @foreach ($detail->belanja_barang as $belanja => $b)
                                        <div class="row delete_detail {{ $belanja != 0 ? 'mt-3' : '' }}">
                                            <div class="col-md">
                                                <select id="selectDetail{{ $b->id }}" name="selectDetail[]"
                                                    ...
                                                    <option value="1"
                                                        ...
                                                        Approve</option>
                                                    <option value="6" {{ $b->status == 6 ? 'selected' : '' }}>
                                                        Pending</option>
                                                    <option value="4" {{ $b->status == 4 ? 'selected' : '' }}>Tolak
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                <select id="akun{{ $b->id }}" name="akun[]"
                                                    class="form-control akun" required></select>
                                            </div>
                                            <div class="col-md">
                                            ...
                                            <div class="col-md">
                                                <input id="qty{{ $b->id }}" name="qty[]" class="form-control"
                                                    type="number" onkeyup="updateTotal({{ $b->id }})"
                                                    min="1" value="{{ $b->qty }}" readonly required />
                                            </div>
                                            <div class="col-md">
                                            ...
                                            <div class="col-md-2">
                                                <input id="harga{{ $b->id }}" name="harga[]"
                                                    ...
                                                    onkeyup="updateTotal({{ $b->id }})" min="1" readonly
                                                    required />
                                            </div>
                                            <div class="col-md">
                                                <input id="keterangan{{ $b->id }}" name="keterangan[]"
                                                    class="form-control keterangan text-white"
                                                    value="{{ $b->keterangan }}" style="background-color:#25a0e2" />
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8" style="background-color: #4E36E2">
                                            <input class="form-control text-end total fs-20 text-white mt-1"
                                                id="total_nilai"
                                                style="border-color:#4E36E2; background-color: #4E36E2" value="0"
    ...
    $(function() {
        $.each(f, function(i, item) {
            ...
            $('#selectDetail' + item.id).change(function(e) {
                if (this.value == 1) {
                    $('#total_nilai').val(parseInt($('#total_nilai').val().replace("Rp. ", "")
                        .replaceAll(",", "").replaceAll(".", "")) + parseInt($(
                        '#jumlah' + item.id).val().replace("Rp. ", "").replaceAll(
                        ",", "").replaceAll(".", "")))
