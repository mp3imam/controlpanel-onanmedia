    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="col">
                    <button type="button" class="btn btn-danger btn-icon waves-effect waves-light float-end"
            ...
            <div class="card-body">
                <form action="{{ route('master_kas_belanja.update', $detail->id) }}" method="POST"
                    ...
                    <div class="row">
                                        ...
                                        @foreach ($detail->kas_file as $foto => $f)
                                            <div id="carousel{{ $f->id }}"
                                                ...
                                                <img id="{{ $f->id }}" class="d-block" width="100%"
                                                    height="300px" src="{{ asset('kas_belanja') . '/' . $f->filename }}">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <a href="{{ asset('kas_belanja') . '/' . $f->filename }}"
                                                        target="_blank"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="date" class="form-control" id="tanggal_transaksi" name="tanggal_transaksi"
                                value="{{ $detail->tanggal_transaksi }}" required />
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div>
                                ...
                                <div class="form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis" id="jenis_transaksi_1"
                                        {{ $detail->jenis == 1 ? "checked=''" : '' }} value="1">
                                ...
                                <div class="form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis"
                                        id="jenis_transaksi_2" {{ $detail->jenis == 2 ? "checked=''" : '' }}
                                        value="2">
                                        ...
                                        <div class="row delete_detail mt-2">
                                            <div class="col-md-3">
                                                <select id="akun_belanja{{ $b->id }}" name="akun_belanja[]"
                                                    class="form-control akun_belanja" required></select>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input class="form-control nilai text-end" number="nilai[]"
                                                    name="nilai[]" value="{{ $b->nominal }}"
                                                    onkeyup="countNilai()" required />
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control text-end total fs-20 text-white"
                                                style="background-color: #4E36E2" id="total_nilai"
                                                value="{{ $detail->nominal }}" name="total_nilai" readonly />
                                        </div>
                    ...
                    <div class="float-end">
                        <button class="btn btn-success mr-5 rounded-5 bg-animation"
...
<script>
    ...
    var data = {
        id: "{{ $detail->coa_belanja->id }}",
        text: "{{ $detail->coa_belanja->uraian }}",
        selected: true
    };
                    ...
                    success: function(result) {
                        Swal.fire({
                            ...
                            window.location.href =
                                "{{ route('master_kas_belanja.index') }}";
                        });
                    }
                });
            }
