            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ URL('/') }}" class="logo logo-dark py-3">
                        ...
                        <span class="logo-lg">
                            <img src="{{ URL::asset('assets/images/logo/onanmedia-login.png') }}" alt="" width="50" height="50">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge badge-soft-light fs-13"> Baru</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="#"><i class="mdi mdi-form-textbox-password text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Ubah Sandi</span></a>
