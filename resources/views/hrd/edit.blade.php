                                ...
                                <div class="tab-pane active" id="base-umum" role="tabpanel">
                                    <div class="row">
                                        <div id="alert_nama_lengkap_umum" class="col-lg-6 p-2 mx-1 mb-3 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <input class="form-control" id="nama_lengkap_umum" name="nama_lengkap_umum" value="{{ $detail->nama_lengkap }}">
                                        </div>
                                        <div id="alert_nama_panggilan_umum" class="col-lg p-2 mx-1 mb-3 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <input class="form-control" id="nama_panggilan_umum" name="nama_panggilan_umum" value="{{ $detail->nama_panggilan }}">
                                        </div>
                                        ...
                                        <div class="col-lg-6 p-2 mx-1 mb-3 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <input class="form-control" id="nik_khusus_umum" name="nik_khusus" value="{{ $detail->nik_khusus }}">
                                        </div>
                                        ...
                                        <div id="alert_tempat_lahir_umum" class="col-lg-6 p-2 mx-1 mb-3 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <input class="form-control" id="tempat_lahir_umum" name="tempat" value="{{ $detail->tempat_lahir }}">
                                        </div>
                                        <div id="alert_tanggal_lahir_umum" class="col-lg p-2 mx-1 mb-3 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_lahir_umum" name="tanggal_lahir" value="{{ $detail->tanggal_lahir }}">
                                        </div>
                                        <div class="col-lg-6 p-2 mb-3 mx-1 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <select class="form-control" id='jenis_kelamin_umum' name="jenis_kelamin">
                                                <option value="1" value="{{ $detail->jenis_kelamin == 1 ? "selected" : "" }}">Laki-Laki</option>
                                                <option value="2" value="{{ $detail->jenis_kelamin == 2 ? "selected" : "" }}">Perempuan</option>
                                            </select>
                                        </div>
                                        <div id="alert_no_handphone_umum" class="col-lg p-2 mb-3 mx-1 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <input class="form-control" id="no_hp_umum" name="no_hp" value="{{ $detail->no_handphone }}">
                                        </div>
                                        <div class="col-lg-12 p-2 mb-3 mx-1 rounded-3" style="background-color: #F9FAFB">
                                            <label class="control-form text-muted">Email</label>
                                            <input class="form-control" id="email_umum" name="email" value="{{ $detail->email }}">
                                        </div>
...
@section('script')
    ...
    function modal_crud_keluarga(data, id, nama, agama, tanggal_lahir){
        ...
        $(function() {
            ...
            var dataRole = {
                id: '{{ $detail->agama_id }}',
                text: '{{ $detail->agama_personal->nama }}',
                selected: true
            };

            $('#agama_id_umum').append(new Option(dataRole.text, dataRole.id, false, false)).trigger('change');
            ...
            $('#agama_id_umum').select2({
                ajax: {
                    ...
                    dataType: 'json',
                    delay: 250,
                    processResults: data => ({ results: data.data.map(item => ({ id: item.id, text: item.name })) }),
                    cache: true
                }
            });

            var dataRole = {
                id: '{{ $detail->pendidikan_terakhir }}',
                text: '{{ $detail->pendidikan_terakhir_banget->nama }}',
                selected: true
            };

            $('#pendidikan_id_umum').append(new Option(dataRole.text, dataRole.id, false, false)).trigger('change').select2();
