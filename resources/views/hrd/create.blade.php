                            ...
                            <div class="tab-content mt-4">
                                ...
                                <div class="tab-pane" id="base-personal" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg p-2 mx-1 mb-3 rounded-3" style="background-color: #F9FAFB">
                                            ...
                                            <input type="number" class="form-control" id="NPWP_personal"
                                                name="NPWP">
                                        </div>
                                        <div class="col-lg-6 p-2 mx-1 mb-3 rounded-3" style="background-color: #F9FAFB">
                                        ...
                                        <div class="col-lg-12 p-2 mb-3 mx-1">
                                            <button id="save_personal" disabled class="btn text-white float-end"
                                                style="background-color: #4E36E2">Simpan</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="base-pekerjaan" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 p-2 mb-3 mx-1">
                                            <button id="save_pekerjaan" disabled class="btn text-white float-end"
                                                style="background-color: #4E36E2">Simpan</button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md p-3 text-center">
                                                    <button disabled type="button" id="tambah_keluarga"
                                    ...
                                    <div class="col-lg-12">
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md p-3 text-center">
                                                    <button type="button" disabled id="tambah_pendidikan"
                                    ...
                                    <div class="col-lg-12">
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md p-3 text-center">
                                                    <button type="button" disabled id="tambah_pelatihan"
                                    ...
                                    <div class="col-lg-12">
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md p-3 text-center">
                                                    <button type="button" disabled id="tambah_riwayat"
