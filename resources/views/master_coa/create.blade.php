                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="col-md mb-4 kdrek1_coa_hidden">
                                    ...
                                    <select id="kdrek1_coa_id" name="kdrek1_coa_id" class="form-control kdrek1_coa_hidden"
                                        required></select>
                                </div>
                                <div class="col-md mb-4 kdrek2_coa_hidden">
                                    <label for="kdrek2_coa" class="form-label kdrek2_coa_hidden">Deskripsi Coa</label>
                                    <select id="kdrek2_coa_id" name="kdrek2_coa_id" class="form-control kdrek2_coa_hidden"
                                        required></select>
                                </div>
                                <div class="col-md mb-4 kdrek3_coa_hidden">
                                    <label for="kdrek3_coa" class="form-label kdrek3_coa_hidden">Uraian Coa</label>
                                    <select id="kdrek3_coa_id" name="kdrek3_coa_id"
                                        class="form-control kdrek3_coa_hidden"></select>
                                </div>
                            </div>
                            <div class="row">
                ...
                $("#kdrek2_coa_id").select2({
                    ...
                    if ($('#pilih_data_id').val() != "3") {
                        $("#kdrek3_coa_id").select2({
                            ...
                            width: '100%',
                            ajax: {
                                url: "{{ route('api.get_select2_kdrek3') }}?kdrek1=" + e.params.data
                                    .kdrek1 + "&kdrek2=" + e.params.data.kdrek2 + "&kdrek3=" + e
                                    .params.data.kdrek3,
                                dataType: 'json',
                                delay: 250,
                                processResults: function(data) {
                            ...
                            $.ajax({
                                url: "{{ url('api/count_kdrek_coa') }}?kdrek1=" + e.params
                                    .data.kdrek1 + "&kdrek2=" + e.params.data.kdrek2 +
                        ...
                        $.ajax({
                            type: "get",
                            url: "{{ url('api/count_kdrek3_coa') }}?kdrek1=" + e.params.data
