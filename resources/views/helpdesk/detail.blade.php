                        ...
                        <div id="append_chat">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-end text-muted mt-2">
                                    <label
                                        class="mt-2 fs-16">{{ Carbon\Carbon::parse($detail->createdAt)->addHours(7)->isoFormat('dddd, D MMMM - HH:mm:ss a') }}</label>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-md-12">
                            ...
                            @if ($detail->detail->isNotEmpty())
                                @foreach ($detail->detail as $dtl => $d)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-end text-muted mt-2">
                                            <label
                                                class="mt-2 fs-16">{{ Carbon\Carbon::parse($d->createdAt)->addHours(7)->isoFormat('dddd, D MMMM - HH:mm:ss a') }}</label>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-md-12 mt-4">
