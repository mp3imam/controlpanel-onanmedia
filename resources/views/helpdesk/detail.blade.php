                                        ...
                                        <div class="col-md-12 my-4">
                                            @if ($d->file_details->isNotEmpty())
                                                @foreach ($d->file_details as $file => $f)
                                                    <a class="mx-2" href="{{ $f->url }}" target="_blank">{{ $f->fileName }}</a>
                                                @endforeach
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        <form action="{{ route('helpdesk.upload.image') }}" enctype="multipart/form-data" class="dropzone dz-clickable" style="width: 100%; height: 100px; min-height: 0px !important;" id="image-upload" method="post" id="gambar-dropzone">
                                            @csrf
